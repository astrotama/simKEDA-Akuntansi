<?php
function laporanbp2d2_main($arg=NULL, $nama=NULL) {
...
function getlaporanbp2d2(){
	...
	$rows[]=array(
		array('data' => 'SURAT KETERANGAN PENGAJUAN SPP-LS GAJI TUNJANGAN', 'width' => '625px','align'=>'center','style'=>'border:none;font-size:125%;font-weight:bold;text-decoration:underline;'),
	);
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan Pembayaran Langsung Gaji dan Tunjangan(LS GAJI TUNJANGAN) yang kami ajukan sebesar Rp. 193.021.457 (terbilang Seratus Sembilah Puluh Tiga Juta Dua Puluh Satu Ribu Empat Ratus Lima Puluh Tujuh Rupiah) untuk keperluan SKPD BADAN PERENCANAAN PEMBANGUNAN DAERAH Tahun Anggaran 2016, dengan ini menyatakan dengan sebenarnya bahwa jumlah tersebut digunakan untuk keperluan sebagai berikut:', 'width' => '625px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'No.', 'width' => '25px','align'=>'center','style'=>'border:1px solid black;'),
		array('data' => 'Kode Rekening', 'width' => '200px','align'=>'left','style'=>'border:1px solid black;'),
		array('data' => 'Uraian', 'width' => '200px','align'=>'left','style'=>'border:1px solid black;'),
		array('data' => 'Jumlah', 'width' => '200px','align'=>'left','style'=>'border:1px solid black;'),
	);
	$total=0;
	for($n=0;$n<10;$n++){
		$jumlah=$n*500000;
		...
		$rows[]=array(
			...
			array('data' => 'Kode Rekening', 'width' => '200px','align'=>'left','style'=>'border-right:1px solid black;'),
			array('data' => 'Uraian', 'width' => '200px','align'=>'left','style'=>'border-right:1px solid black;'),
			array('data' => $jumlah, 'width' => '200px','align'=>'left','style'=>'border-right:1px solid black;'),
		);
		
	}
	$rows[]=array(
			array('data' => 'Jumlah', 'width' => '425px','align'=>'right','style'=>'border-left:1px solid black;border-right:1px solid black;'),
			array('data' => $total, 'width' => '200px','align'=>'left','style'=>'border-right:1px solid black;'),
		);
	
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan SPP-LS GAJI TUNJANGAN SKPD', 'width' => '625px','align'=>'left','style'=>'border:none;'),
	);
	$rows[] = array(
