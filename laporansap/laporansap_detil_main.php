<?php
function laporansap_detil_main($arg=NULL, $nama=NULL) {
    $cetakpdf = '';
		...
		$btn = '<div class="btn-group">' .
				...
				'</button>' .
					'<ul class="dropdown-menu">' .
						'<li><a href="/laporansapdetil/filter/' . $bulan . '/' . urlencode($kodeuk) . '/' . $akun . '/' . $margin . '/' . $marginkiri . '/kum">Realisasi Kumulatif</a></li>' .
						'<li><a href="/laporansapdetil/filter/' . $bulan . '/' . urlencode($kodeuk) . '/' . $akun . '/' . $margin . '/' . $marginkiri . '/per">Realisasi Periodik</a></li>' .
					'</ul>' .
				'</div>';		
		$btn .= '&nbsp;<div class="btn-group">' .
				...
				'</button>' .
					'<ul class="dropdown-menu">' .
						'<li><a href="/laporansapdetil/filter/' . $bulan . '/' . urlencode($kodeuk) . '/' . $akun . '/' . $margin . '/' . $marginkiri . '/excelkum">Realisasi Kumulatif</a></li>' .
						'<li><a href="/laporansapdetil/filter/' . $bulan . '/' . urlencode($kodeuk) . '/' . $akun . '/' . $margin . '/' . $marginkiri . '/excelper">Realisasi Periodik</a></li>' .
					'</ul>' .
				'</div>';		
