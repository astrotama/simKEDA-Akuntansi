...
function pendapatanjurnaluk_main($arg=NULL, $nama=NULL) {
	...
	foreach ($results as $data) {
		...
		$editlink = apbd_button_jurnal('pendapatanjurnaluk/jurnaledit/' . $data->jurnalid);
	...
	//BUTTON
	$btn = apbd_button_baru('/pendapatanjurnalukman');
	$btn .= "&nbsp;" . apbd_button_print('/pendapatanjurnaluk/filter/' . $kodeuk . '/' . $bulan . '/' . $keyword . '/pdf');
