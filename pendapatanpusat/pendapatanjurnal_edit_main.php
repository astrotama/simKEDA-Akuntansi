...
function pendapatanjurnal_edit_main_form($form, &$form_state) {
	...
	*/
	...
	$form['transid'] = array(
		...
		'#markup' => '<div class="row"><div class="col-md-4"><h3></h3></div><div class="col-md-8"><p class="text-right">' . apbd_link_cetakjurnal($jurnalid) .  '</p></div></div>',
	);	
	/*
	$form['tanggal'] = array(
		'#type' => 'date',
...
function pendapatanjurnal_edit_main_form_submit($form, &$form_state) {
	...
	*/
	...
	} else if($form_state['clicked_button']['#value'] == $form_state['values']['detiladd']) {
